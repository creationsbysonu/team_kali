...
class AllTokensTab extends StatelessWidget {
  const AllTokensTab({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<StaffPanelBloc, StaffPanelState>(
      buildWhen: (previous, current) =>
          previous.allTokensData != current.allTokensData ||
          previous.isLoadingAll != current.isLoadingAll ||
          previous.isLoading != current.isLoading ||
          previous.isInitialized != current.isInitialized ||
          previous.allTokensError != current.allTokensError,
