...
class PendingTokensTab extends StatelessWidget {
  const PendingTokensTab({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<StaffPanelBloc, StaffPanelState>(
      buildWhen: (previous, current) =>
          previous.pendingTokensData != current.pendingTokensData ||
          previous.isLoadingPending != current.isLoadingPending ||
          previous.isLoading != current.isLoading ||
          previous.isInitialized != current.isInitialized ||
          previous.pendingTokensError != current.pendingTokensError,
