...
class ActiveTokensTab extends StatelessWidget {
  const ActiveTokensTab({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<StaffPanelBloc, StaffPanelState>(
      buildWhen: (previous, current) =>
          previous.activeTokensData != current.activeTokensData ||
          previous.isLoadingActive != current.isLoadingActive ||
          previous.isLoading != current.isLoading ||
          previous.isInitialized != current.isInitialized ||
          previous.activeTokensError != current.activeTokensError,
            ...
            child: Column(
              ...
              children: [
                ...
                if (waitingTokens.isEmpty)
                  ...
                  ...waitingTokens.map(
                    (token) => _WaitingTokenCard(token: token),
                  ),
              ],
            ),
          ),
